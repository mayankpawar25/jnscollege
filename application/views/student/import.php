...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var class_nep_id = $('#class_nep_id').val();
        var section_nep_id = '<?php echo set_value('section_nep_id') ?>';
        getSectionByClass(class_nep_id, section_nep_id);
        $(document).on('change', '#class_nep_id', function(e) {
            $('#section_nep_id').html("");
            var class_nep_id = $(this).val();
            var base_url = '<?php echo base_url() ?>';
            var div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>';
            $.ajax({
                type: "GET",
                ...
                success: function(data) {
                    ...
                    $('#section_nep_id').append(div_data);
                }
            });
        });
    });
