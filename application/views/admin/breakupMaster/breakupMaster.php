            ...
            <?php if ($this->rbac->hasPrivilege('fees_master', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/breakupmaster"  id="breakupsform" name="breakupsform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="breakup_name" name="breakup_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('breakup_name'); ?>" />
