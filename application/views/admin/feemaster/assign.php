                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/feemaster/assign/' . $id) ?>" method="post" class="row">
                            ...
                            <!-- yojna filter add fee master -->
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('yojna');
                                            ?></label>
                                    <select class="form-control" name="yojna">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php

                                        foreach (get_custom_yojna_value('yojna') as $key => $value) {
                                        ?>
                                            <option value="<?php echo $value->field_value; ?>" <?php if (set_value('yojna') == $value->field_value) {
                                                                                                    echo "selected";
                                                                                                }
                                                                                                ?>><?php echo $value->field_value; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
